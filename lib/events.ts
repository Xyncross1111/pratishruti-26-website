...
export const registrationEvents: RegistrationEvent[] = [
  {
    ...
    formFields: [
      ...
      { id: 'collegeName', label: 'College Name', type: 'text', required: true },
      {
  ...
  },
  {
    ...
    formFields: [
      { id: 'fullName', label: 'Full Name', type: 'text', required: true },
      { id: 'rknecEmail', label: 'RKNEC/RBU Email ID', type: 'email', required: true },
      { id: 'contactNumber', label: 'Contact Number', type: 'tel', required: true },
      { id: 'branchSection', label: 'Branch-Section', type: 'text', required: true },
      {
        id: 'yearOfStudy',
        label: 'Year of Study',
        type: 'select',
...
export function getEventById(id: number | string): RegistrationEvent | undefined {
 ...
 */
export function getEventFromParam(param: string | null | undefined): RegistrationEvent | undefined {
