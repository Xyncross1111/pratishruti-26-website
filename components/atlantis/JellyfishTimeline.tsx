...
const timelineEvents = [
  {
    ...
    description:
      "Chief Guest: Mr. Sarang Dewaikar. Presided by Shri Satyanarayan Nuwal in presence of Shri Rajendra Purohit. Kickstarts Pratishurti 2026.",
  },
  {
  ...
  },
  {
    ...
    description:
      "Chief Guest: Mr. Kuldeep Vij with valedictory and awards ceremony where students are recognized for their achievements during the academic year.",
  },
  {
